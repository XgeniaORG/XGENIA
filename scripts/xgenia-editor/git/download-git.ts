...
export async function gitSimpleDownload(options: { outputPath: string; platform: string; architecture: string }) {
  ...
  console.log(`XGENIA Build: Download git natives for ${targetName}...`);
  ...
  console.log(`XGENIA Build: Clean up git natives...`);
  ...
  console.log('XGENIA Build: -- End Git');
}
