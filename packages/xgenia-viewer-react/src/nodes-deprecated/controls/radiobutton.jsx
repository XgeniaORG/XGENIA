...
function RadioButton(props) {
  ...
  if (props.boxShadowEnabled) {
    style.boxShadow = `${props.boxShadowInset ? 'inset ' : ''}${props.boxShadowOffsetX} ${props.boxShadowOffsetY} ${props.boxShadowBlurRadius
...
var RadioButtonNode = {
  ...
  docs: 'https://docsapp.xgenia.com/nodes/visual/radiobutton',
  allowChildren: false,
