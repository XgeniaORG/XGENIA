/** @jsxRuntime classic */
// No explicit React import needed for JSX with new transform, but keep for linter/old setups
import * as React from 'react'; // Use namespace import
// import css from './NoHomeError.module.css'; // Removed unused import for non-existent file
  ...
  return (
    ...
    >
      <div style={{ marginBottom: '50px', fontWeight: 'bold', display: 'flex', alignItems: 'center' }}>
        <span>ERROR</span>
        <img src="ndl_assets/xgenia-logo-black.svg" style={{ marginLeft: 'auto' }} />
      </div>
