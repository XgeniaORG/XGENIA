...
export interface SelectProps extends XGENIA.ReactProps {
  id: string;
  value: string;
  enabled: boolean;
...
export function Select(props: SelectProps) {
  ...
  const inputProps = {
    ...
    style: {
      ...
      cursor: (props.enabled ? '' : 'default') as React.CSSProperties['cursor'],
      WebkitAppearance: 'none' as React.CSSProperties['WebkitAppearance'] //this makes styling possible on Safari, otherwise the size will be incorrect as it will use the native styling
    },
  ...
  const inputWrapper = (
    <div className="ndl-controls-pointer" style={inputWrapperStyle} xgenia-style-tag="inputWrapper">
      ...
      <select
        ...
        value={options.find((i: any) => i.props && i.props.value === value) ? value : undefined}
