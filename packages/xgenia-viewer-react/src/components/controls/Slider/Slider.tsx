...
export interface SliderProps extends XGENIA.ReactProps {
  _nodeId: string;
  id: string;
  enabled: boolean;
...
export function Slider(props: SliderProps) {
  ...
  const trackStyle: React.CSSProperties = {
    ...
    background: `linear-gradient(to right, ${props.trackActiveColor} 0%, ${props.trackActiveColor} ${valueFactor * 100
