...
const Node = require('@xgenia/runtime').Node;
const JavascriptNodeParser = require('@xgenia/runtime/src/javascriptnodeparser');
const { logJavaScriptNodeError } = require('@xgenia/runtime/src/utils');
...
var Javascript = {
  name: 'Javascript2',
  docs: 'https://docsapp.xgenia.com/nodes/javascript/script',
