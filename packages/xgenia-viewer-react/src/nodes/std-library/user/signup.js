...
const SignUpNodeDefinition = {
  name: 'net.xgenia.user.SignUp',
  docs: 'https://docsapp.xgenia.com/nodes/data/user/sign-up',
...
module.exports = {
  ...
  setup(context, graphModel) {
    ...
    graphModel.on('editorImportComplete', () => {
      graphModel.on('nodeAdded.net.xgenia.user.SignUp', function (node) {
        _managePortsForNode(node);
      });

      for (const node of graphModel.getNodesWithType('net.xgenia.user.SignUp')) {
        _managePortsForNode(node);
      }
    });
  }
