...
export default {
  ...
  argTypes: {}
} as Meta<typeof ColorListView>;

const Template: StoryFn<typeof ColorListView> = (args) => <ColorListView {...args} />;
...
Common.args = {
  items: [
    ...
    { id: 30, text: 'XGENIA Dark', color: '#171717' },
    { id: 31, text: 'XGENIA Yellow', color: '#F5BC41' },
