...
import { InputNotification, InputNotificationDisplayMode } from '@xgenia-types/globalInputTypes';
...
import { SingleSlot, UnsafeStyleProps } from '@xgenia-core-ui/types/global';
