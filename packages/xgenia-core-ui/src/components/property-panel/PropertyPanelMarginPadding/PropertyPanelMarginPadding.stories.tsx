...
import { PropertyPanelSection } from '@xgenia-core-ui/components/property-panel/PropertyPanelSection';
...
export default {
  ...
  argTypes: {}
} as Meta<typeof PropertyPanelMarginPadding>;

const Template: StoryFn<typeof PropertyPanelMarginPadding> = (args) => {
