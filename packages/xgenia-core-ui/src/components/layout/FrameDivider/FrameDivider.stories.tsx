...
import { TestView } from '@xgenia-core-ui/components/layout/TestView/TestView';

export default {
  title: 'Layout/Frame Divider',
  component: FrameDivider,
  argTypes: {}
} as Meta<typeof FrameDivider>;

const Template: StoryFn<typeof FrameDivider> = (args) => (
...
export const Editor3Horizontal: StoryFn<typeof FrameDivider> = () => {
...
export const Editor3Vertical: StoryFn<typeof FrameDivider> = () => {
...
export const Editor2Horizontal1Vertical: StoryFn<typeof FrameDivider> = () => {
  const [firstSize, setFirstSize] = useState(300);
  const [secondSize, setSecondSize] = useState(300);
