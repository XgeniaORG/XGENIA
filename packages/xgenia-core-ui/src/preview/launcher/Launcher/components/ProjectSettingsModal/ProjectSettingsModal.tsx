...
import { Modal, ModalProps } from '@xgenia-core-ui/components/layout/Modal';
        ...
        <Box hasTopSpacing>
          <Card background={CardBackground.Bg2}>
            ...
            <Text hasBottomSpacing>
              Versioning and branching can be managed inside of the XGENIA editor. User access has to be managed with
              your Git provider.
            </Text>
