...
import { Card, CardBackground } from '@xgenia-core-ui/components/common/Card';
...
import { HStack, Stack, VStack } from '@xgenia-core-ui/components/layout/Stack';
import { ContextMenu, ContextMenuProps } from '@xgenia-core-ui/components/popups/ContextMenu';
import { Tooltip } from '@xgenia-core-ui/components/popups/Tooltip';
import { Label, LabelSize, LabelSpacingSize } from '@xgenia-core-ui/components/typography/Label';
...
import { UserBadgeProps, UserBadgeSize } from '@xgenia-core-ui/components/user/UserBadge';
import { UserBadgeList } from '@xgenia-core-ui/components/user/UserBadgeList';
          ...
          <Columns layoutString="1 1 1" hasXGap={4}>
            ...
            <HStack UNSAFE_style={{ justifyContent: 'space-between', alignItems: 'center' }} hasSpacing={4}>
              <HStack UNSAFE_style={{ alignItems: 'center' }} hasSpacing={2}>
                ...
                <UserBadgeList
                  badges={contributors || [{ name: 'Tore Knudsen', email: 'tore@xgenia.net', id: 'Tore' }]}
