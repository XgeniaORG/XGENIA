...
import {
  CloudSyncType,
  LauncherProjectData
} from '@xgenia-core-ui/preview/launcher/Launcher/components/LauncherProjectCard';
import { LauncherSidebar } from '@xgenia-core-ui/preview/launcher/Launcher/components/LauncherSidebar';
import { LearningCenter } from '@xgenia-core-ui/preview/launcher/Launcher/views/LearningCenter';
import { Projects } from '@xgenia-core-ui/preview/launcher/Launcher/views/Projects';
...
export const MOCK_PROJECTS: LauncherProjectData[] = [
  ...
  },
  {
    ...
    pushAmount: 666,
    contributors: [
      { email: 'tore@xgenia.net', name: 'Tore Knudsen', id: 'Tore' },
      { email: 'eric@xgenia.net', name: 'Eric Tuvesson', id: 'Eric' }
    ]
  },
  {
    id: '3',
    ...
    contributors: [
      { email: 'tore@xgenia.net', name: 'Tore Knudsen', id: 'Tore' },
      { email: 'eric@xgenia.net', name: 'Eric Tuvesson', id: 'Eric' },
      { email: 'michael@xgenia.net', name: 'Michael Cartner', id: 'Michael' },
      { email: 'mikael@xgenia.net', name: 'Mikael Tellhed', id: 'Mikael' },
      { email: 'anders@xgenia.net', name: 'Anders Larsson', id: 'Anders' },
      { email: 'johan@xgenia.net', name: 'Johan Olsson', id: 'Johan' },
      { email: 'victor@xgenia.net', name: 'Victor Permild', id: 'Victor' },
      { email: 'kotte@xgenia.net', name: 'Kotte Aistre', id: 'Kotte' }
    ]
  },
  {
    id: '4',
