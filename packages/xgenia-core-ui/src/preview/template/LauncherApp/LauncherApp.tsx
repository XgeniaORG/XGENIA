...
import { Logo } from '@xgenia-core-ui/components/common/Logo';
import { ExternalLink } from '@xgenia-core-ui/components/inputs/ExternalLink';
...
import { ListItem } from '@xgenia-core-ui/components/layout/ListItem';
...
import { UserListingCard, UserListingCardVariant } from '@xgenia-core-ui/components/user/UserListingCard';
    ...
    <Container direction={ContainerDirection.Vertical} hasSpaceBetween>
        ...
        <Section>
          <Container hasXSpacing hasYSpacing>
            <Container hasXSpacing hasTopSpacing>
              <UserBadge email="john@xgenia.net" id="20" name="John Doe" size={UserBadgeSize.Small} hasRightSpacing />
              <UserBadge email="john@xgenia.net" id="20" name="John Doe" size={UserBadgeSize.Small} hasRightSpacing />
              <UserBadge email="john@xgenia.net" id="20" name="John Doe" size={UserBadgeSize.Small} hasRightSpacing />
              <UserBadge email="john@xgenia.net" id="20" name="John Doe" size={UserBadgeSize.Small} hasRightSpacing />
              <UserBadge email="john@xgenia.net" id="20" name="John Doe" size={UserBadgeSize.Small} hasRightSpacing />
      ...
      <Section>
        <Container direction={ContainerDirection.Vertical} hasXSpacing hasYSpacing>
          <UserListingCard variant={UserListingCardVariant.Launcher} email="john@xgenia.net" id="20" name="John Doe" />
        </Container>
      </Section>
    </Container>
  );
...
export function LauncherApp({ title = 'XGENIA Launcher', sidePanel, children }: LauncherAppProps) {
