...
import { SideNavigation } from '@xgenia-core-ui/components/app/SideNavigation';
import { TitleBar } from '@xgenia-core-ui/components/app/TitleBar';
...
export function DefaultApp({ title = 'XGENIA Storybook', panel, document }: DefaultAppProps) {
