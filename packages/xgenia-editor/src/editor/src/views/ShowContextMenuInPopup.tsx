...
import { MenuDialog, MenuDialogItem, MenuDialogWidth } from '@xgenia-core-ui/components/popups/MenuDialog';
...
export function showContextMenuInPopup({
    ...
    // Get the current cursor and window positions
    ...
    // Show the popout using PopupLayer, and set onClose to unmount the React component
    ...
    // Render the MenuDialog into the container using the new root
    root.render(
        <MenuDialog
            title={title}
