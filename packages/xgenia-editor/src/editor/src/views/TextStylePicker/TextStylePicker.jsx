...
import { IconName, IconSize } from '../../../../../../xgenia-core-ui/src/components/common/Icon';
import { IconButton, IconButtonVariant } from '../../../../../../xgenia-core-ui/src/components/inputs/IconButton';
...
function TextStylePicker(props) {
  ...
  useEffect(() => {
    if (!styleToEdit || !popupAnchor) return;
      ...
      const popupRoot = createRoot(div); // Create the React 18 root
      popupRoot.render(<TextStylePopup style={styleToEdit} stylesModel={stylesModel} />);
