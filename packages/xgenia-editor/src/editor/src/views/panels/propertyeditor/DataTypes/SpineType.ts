...
export class SpineType extends TypeView {
  el: TSFixme;

  static fromPort(args) {
    const view = new SpineType();
  ...
  render() {
    ...
    this.$('input')
      ...
      .on('click', function (e) {
        ...
        //spinePicker.setFilter($(this).val());
        spinePicker.render();
      ...
      .on('keyup', function (e) {
        spinePicker && spinePicker.setFilter($(this).val());
      });
