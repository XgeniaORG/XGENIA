...
class CurveEditor extends React.Component {
  ...
  constructor(props) {
    ...
    this.animationPlupRef = React.createRef();
  ...
  testTiming() {
    const animationPlup = this.animationPlupRef.current;
    animationPlup.style.transition = 'none';
    animationPlup.style.transform = 'translate(30px)';
    void animationPlup.offsetWidth;
    animationPlup.style.transition = 'transform';
    animationPlup.style.transitionDuration = this.state.duration + 'ms';
    animationPlup.style.transitionDelay = this.state.delay + 'ms';
    animationPlup.style.transitionTimingFunction =
      'cubic-bezier(' + this.getCssBezierValues().join(',') + ')';
    void animationPlup.offsetWidth;
    animationPlup.style.transform = 'translate(180px)';
  }
  ...
  render() {
    return (
      <div style={{ width: '270px', height: '370px' }}>
        ...
        >
          <div ref={this.animationPlupRef} style={{ ...Styles.animationPlup, transform: 'translate(30px)' }}></div>
        </div>
      </div>
    );
  }
