            ...
            {q.operator !== undefined && q.operator !== 'exist' && q.operator !== 'not exist' ? (
              <span>
                ...
                {q.value !== undefined && q.input === undefined ? (
                  <span>
                    the value
                    <span className="queryeditor-span-strong">
                      {typeof q.value === 'object' ? JSON.stringify(q.value) : String(q.value)}
                    </span>
                  </span>
                ) : null}
                ...
                {q.input !== undefined ? (
                  <span>
                    the input
                    <span className="queryeditor-span-strong">
                      {typeof q.input === 'string' ? q.input : 
                       typeof q.input === 'object' && q.input !== null ? 
                         (q.input.name || q.input.id || JSON.stringify(q.input)) : 
                         String(q.input)}
                    </span>
                  </span>
                ) : null}
