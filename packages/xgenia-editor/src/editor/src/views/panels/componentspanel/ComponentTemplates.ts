...
class LogicComponentTemplate extends ComponentTemplate {
  constructor() {
    super('Logic Component', IconName.Code);

    this.parentTypes = ['folder', 'component'];
    this.runtimeTypes = ['cloud', 'browser', 'maths'];
...
class MathsComponentTemplate extends ComponentTemplate {
  constructor() {
    super('Maths Component', IconName.StructureCircle);

    this.parentTypes = ['folder', 'component'];
    this.runtimeTypes = ['maths'];
