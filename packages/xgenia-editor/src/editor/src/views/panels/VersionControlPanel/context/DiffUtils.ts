...
import { FileStatusKind } from '@xgenia/git/src/core/models/status';
...
} from '@xgenia-utils/projectmerger.diff';

import { IconName } from '@xgenia-core-ui/components/common/Icon';
import { ListItemProps } from '@xgenia-core-ui/components/layout/ListItem';
