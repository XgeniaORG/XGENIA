...
import { DiffType, IDiff, IImageDiff, Image, ITextDiff } from '@xgenia/git/src/core/models/diff-data';
import { Commit } from '@xgenia/git/src/core/models/snapshot';
import { FileChange, FileStatusKind, isFileImage } from '@xgenia/git/src/core/models/status';
import { getBlobBinaryContents } from '@xgenia/git/src/core/show';
import { filesystem, PromiseUtils } from '@xgenia/platform';

import { ComponentModel } from '@xgenia-models/componentmodel';
import { NodeLibrary } from '@xgenia-models/nodelibrary';
import { ProjectModel } from '@xgenia-models/projectmodel';
import { ProjectDiff, ProjectDiffItem } from '@xgenia-utils/projectmerger.diff';
