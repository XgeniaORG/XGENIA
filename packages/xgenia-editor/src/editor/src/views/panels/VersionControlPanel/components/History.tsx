...
import { CommitHistory, CommitHistoryEntry } from '@xgenia/git';
...
import { BranchColor, HistoryItemBranch } from '@xgenia-core-ui/components/version-control/GitHistoryItem';
