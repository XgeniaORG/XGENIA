...
import { useTogglableArray } from '@xgenia-hooks/useTogglableArray';
import React, { useMemo, useState } from 'react';

import { IModule, ModuleLibraryModel } from '@xgenia-models/modulelibrarymodel';
import { arrayIntersection, getMatchIndex } from '@xgenia-utils/common';
...
export function NodePickerSearchView({ itemType, searchInputPlaceholder }: NodePickerSearchViewProps) {
  ...
  const listClass = itemType === 'prefab' ? css['SingleRowScroller'] : css['Grid'];
