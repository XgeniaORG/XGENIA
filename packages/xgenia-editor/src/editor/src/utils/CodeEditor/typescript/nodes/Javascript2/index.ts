...
function functionLib(node: NodeGraphNode) {
  ...
  return [
    ...
    '}',
    '',
    '/** @deprecated Did you mean Script.Inputs? */',
    'declare const Inputs: never;',
    '',
    '/** @deprecated Did you mean Script.Outputs? */',
    'declare const Outputs: never;',
    '',
    'declare const Script: {',
    '  Inputs: Prettify<InputTypes>;',
    '  Outputs: Prettify<OutputTypes>;',
    '',
...
function buildNodeLib(node: NodeGraphNode) {
  const libPathName = 'inmemory://@xgenia/nodes/Javascript2/Javascript2.d.ts';
...
export function registerOrUpdate_Javascript2(node: NodeGraphNode, runtimeType: RuntimeType): TypescriptModule {
