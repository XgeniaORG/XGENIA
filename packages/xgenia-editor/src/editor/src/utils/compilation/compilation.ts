...
import { getGitStats } from '@xgenia-models/CloudServices/GitStats';
import { ProjectModel } from '@xgenia-models/projectmodel';
import { HtmlProcessorParameters } from '@xgenia-utils/compilation/build/processors/html-processor';
import { SitemapBuildScript } from '@xgenia-utils/compilation/passes/sitemap';
import { NodeGraphTraverser } from '@xgenia-utils/node-graph-traverser';
...
// TODO: Make something more global inside @xgenia/platform, to handle this.
...
export class Compilation {
  ...
  private async loadProjectBuildScripts() {
    ...
    const buildScriptLocation = filesystem.join(this.project._retainedProjectDirectory, '.xgenia', 'build-scripts');
