...
/**
 * List all templates from XGENIA docs,
 * currently saved on GitHub and served via GitHub pages.
 */
export class XgeniaDocsTemplateProvider implements ITemplateProvider {
  get name(): string {
    return this.getDocsEndpoint() || 'https://docsapp.xgenia.com';
  }
