module.exports = {
  ...
  library: [
    ...
    },
    {
      ...
      label: 'NFC',
      desc: 'A module that enables connecting with NFC tags. The module only works when running in the XGENIA Shell app.'
    }
  ],
  feed: [
    {
      ...
      body: 'XGENIA is a platform for data driven experience design. With it, designers and developers can quickly prototype data driven experiences built on real or mock data, cloud services and connected devices. Lead times for doing design experiements, that can be tested in live scenarios, can be drastically reduced. Read how Stockholm Transit, SL, with over 800 000 passengers daily used XGENIA to iterate user experiences in the subway. You can find the post <a target="_blank" href="http://www.topp.se/project/stockholm-public-transportation">here</a>.',
