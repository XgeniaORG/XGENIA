...
NodeModel.prototype.removeChild = function(child) {
    // Safety check for undefined/null child
    if (!child) {
        console.warn("Attempted to remove undefined/null child from NodeModel");
        return;
    }
    ...
    if (index !== -1) {
        ...
        console.warn("Child not found in children array during removeChild");
    }
};
