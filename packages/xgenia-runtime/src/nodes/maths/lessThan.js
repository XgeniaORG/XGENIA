...
const LessThanNode = {
  name: 'Less Than',
  docs: 'https://docsapp.xgenia.com/nodes/math/less-than',
  category: 'Math',
  color: 'data',
  searchTags: ['less than', '<', 'lt', 'compare', 'number'],
  initialize: function () {
    ...
    firstNumber: {
      ...
      set: function (value) {
        try {
          ...
          console.error('LessThan Node - First Number error:', error.message);
        }
      }
    },
    secondNumber: {
      ...
      set: function (value) {
        try {
          ...
          this._internal.lastError = error.message;
          console.error('LessThan Node - Second Number error:', error.message);
        }
      }
    }
  },
  ...
  methods: {
    calculate: function () {
      ...
      try {
        ...
        this._internal.lastError = error.message;
        console.error('LessThan Node - Calculate error:', error.message);
        this.sendSignalOnOutput('Done');
      }
    }
  }
