...
var UserNodeDefinition = {
  name: 'net.xgenia.user.User',
  docs: 'https://docsapp.xgenia.com/nodes/data/user/user-node',
...
module.exports = {
  ...
  setup: function (context, graphModel) {
    ...
    graphModel.on('editorImportComplete', () => {
      graphModel.on('nodeAdded.net.xgenia.user.User', function (node) {
        _managePortsForNode(node);
      });

      for (const node of graphModel.getNodesWithType('net.xgenia.user.User')) {
        _managePortsForNode(node);
      }
    });
  }
