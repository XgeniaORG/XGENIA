...
JavascriptNodeParser.createXgeniaAPI = function () {
  // If we are running in browser mode and there is a global XGENIA API object, use it. If not
  // create a new one for this scope.
  return typeof window !== 'undefined' && window.XGENIA !== undefined ? window.XGENIA : {};
};
