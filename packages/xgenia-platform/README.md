...
import "@xgenia/platform-electron";
...
```
$ npm install @xgenia/platform @xgenia/platform-node
```
...
> This API still needs some love to bring a better universal config system to XGENIA.
