This package makes it easier to bundle Parse Dashboard with XGENIA.
...
The files for the Parse Dashboard app itself (e.g. react components, css, icons etc) is built in `/deps/parse-dashboard` and then copied over to `/packages/xgenia-editor/src/editor/parse-dashboard-public`
